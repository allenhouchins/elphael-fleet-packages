...
# REPO_URL="https://github.com/allenhouchins/elphael-fleet-packages.git" ## Uncomment if running locally
...
git commit -m "Add newest Google Chrome installer package"
